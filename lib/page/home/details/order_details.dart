...
import 'package:studylinjiashop/api/models/order_detail_model.dart';
import 'package:studylinjiashop/api/models/order_detail_view_model.dart';
...
class _OrderDetailsState extends State<OrderDetails>{
  ...
  void loadData() async {
    ...
    orderDetailViewModel.getData(widget.orderSn).then((entity){
      if (null != entity) {
